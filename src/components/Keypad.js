...
const Keypad = ({
  ...
  return (
    <>
      <div>
        <Key text={"MC"} orange onClick={onPressMCLR} />
        <Key text={"MR"} orange onClick={onPressMREC} />
        <Key text={"M+"} orange onClick={onPressMADD} />
        <Key text={"M-"} orange onClick={onPressMSUB} />
        <Key text={"MS"} orange onClick={onPressMSTR} />
      </div>
      <div>
